...
afterEach(cleanup);
const updatePermissionGrantClick = jest.fn();
const permissions = [
  {
...
describe("CustomMarkIcon", () => {
  test("check component loaded ", () => {
    const props = { data: { id: "8d4d7810-a513-4956-876b-01c87efc04d6" }, colDef: { field: "READ" } };
    const { getByText, getByTestId } = render(
      <CustomMarkIcon
        ...
        updatePermissionGrantClick={updatePermissionGrantClick}
      />
    );
    const cMI = getByTestId("customMarkIcon");
